        ...
        <div className="fixed inset-0 bg-fin-bg/95 backdrop-blur-2xl flex items-center justify-center z-50 p-6 animate-in fade-in duration-300">
            <div className="bg-fin-card rounded-[40px] w-full max-w-md border border-brand/20 shadow-[0_0_100px_rgba(16,185,129,0.1)] p-10 relative overflow-hidden">
                ...
                <div className="flex items-center gap-4 mb-8">
                    <div className="p-3 bg-brand/20 text-brand rounded-md shadow-lg shadow-brand/10">
                        <Zap size={24} />
                    </div>
                    <div>
                        <h2 className="text-xl font-black text-[var(--text-primary)] uppercase tracking-tight">Conciliar Cuenta</h2>
                        <p className="text-[10px] font-black text-brand uppercase tracking-widest">{account.name}</p>
                    </div>
                </div>

                <div className="space-y-6 relative z-10">
                    <div className="p-4 bg-[#020b14] rounded-md border border-white/5">
                        <p className="text-[10px] font-black text-fin-muted uppercase tracking-widest mb-2">Instrucciones</p>
                        <p className="text-[11px] text-[var(--text-primary)]/70 leading-relaxed">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full bg-[#020b14] border border-brand/20 focus:border-brand rounded-md p-5 text-2xl font-black text-[var(--text-primary)] outline-none transition-all placeholder:text-[var(--text-primary)]/10 tabular-nums"
                            placeholder="0,00"
                            autoFocus
                        />
                    </div>
                    ...
                    <button
                        ...
                        className="w-full py-5 bg-brand text-[#020b14] rounded-md font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-brand/20 hover:bg-white transition-all active:scale-95 disabled:opacity-30"
                    >
                        Ajustar y Conciliar
                    </button>
                </div>

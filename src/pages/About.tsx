...
import { MessageCircle, Linkedin, CheckCircle, Target, Search, Settings, Zap, BarChart2 } from 'lucide-react';
...
const About = () => {
  ...
  return (
    <Layout>
      <div className="bg-[#021019] min-h-screen py-12 md:py-20 relative overflow-hidden">
